...
ROUTE = [
    ...
    {"lvl": "~61", "title": "The Blood Furnace",
     ...
     "leave": "Revered with Honor Hold / Thrallmar &nbsp;·&nbsp; if not yet 62, stay till 62",
     "tips": ["Consider grabbing <b>[Mark of Conquest]</b>, <b>[Mark of Defiance]</b> or <b>[Mark of Vindication]</b> for easier farming.",
    ...
    {"lvl": "63", "title": "The Underbog",
     ...
     "leave": "Revered with Cenarion Expedition &nbsp;·&nbsp; if not yet 64, stay till 64",
     "tips": ["Learn your new skills."]},
    ...
    {"lvl": "70", "title": "Hit Max Level",
     "do": ["GZ! Go to <b>Nutral</b> in Shattrath and grab your flying mount.",
    ...
    {"lvl": "70", "title": "Heroic & Attune Farm",
     "do": ["The Botanica, The Mechanar (take <b>[Harbinger of Doom]</b>), The Arcatraz, The Black Morass.",
            ...
            "Farm <b>The Black Morass</b> till revered with Keepers of Time."],
...
header.hero{padding:54px 22px 30px;text-align:center;border-bottom:1px solid var(--line);
  background:linear-gradient(180deg, rgba(155,214,47,.06), transparent);}
...
<div class="wrap">
  ...
  <footer>
    ...
    <div class="foot-note">A guild fan project &middot; not affiliated with Blizzard. Reworked from the original
    &ldquo;TBC dungeon rep leveling&rdquo; spreadsheet &middot; data links to Wowhead (TBC Classic).</div>
  </footer>
</div>
{PROGRESS_JS}
</body>
